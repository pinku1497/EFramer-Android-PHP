    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Manage Product</span><i class="treeview-indicator fa fa-angle-right"></i></a>
		 ...
		 <li><a class="app-menu__item" href="form-components.html"><i class="app-menu__icon fa fa-laptop"></i></li>
		<span class="app-menu__label">Farmer List</span><i class="treeview-indicator fa fa-angle-right"></i></a></li>
		
		<li><a class="app-menu__item" href="viewpackage.php"><i class="app-menu__icon fa fa-laptop"></i>
		<span class="app-menu__label">Manage Package</span><i class="treeview-indicator fa fa-angle-right"></i></a></li>
		
		
        
       <li class="treeview"><a class="app-menu__item" href="viewpaymenthistory.php"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">View History</span><i class="treeview-indicator fa fa-angle-right"></i></a></li>		
        </li>
              ...
              <div class="col-lg-6">
                <form>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="packagename" type="text" placeholder="Enter Name">
                  </div>
				   <div class="form-group">
                    <label for="exampleInputPassword1">Duration</label>
                    <input class="form-control" id="duration" type="text" placeholder="Enter Name">
                  </div>
				   <div class="form-group">
                    <label for="exampleInputPassword1">Description</label>
                    <input class="form-control" id="description" type="text" placeholder="Enter Name">
                  </div>
                
			   <input class="btn btn-primary" id="submit" value="Submit" name="save" type="submit"/>
			   </form>
            </div>
          </div>
        </div>
...
<?php
	...
	$description=$_GET['description'];
	 ...
	 $sql="insert into package(packagename,duration,description)
	  values('$packagename','$duration','$description')";
