...
<head>
 ...
 <div class="box-content">
	...
	?>
    <tr>
       <td class="center"> <?php echo $row['fr_id'];?></td>
       <td class="center"> <?php echo $row['fname'];?></td>
	    <td class="center"> <?php echo $row['femail'];?></td>
	
            
           <td class="center">
            
          
			 <a class="btn btn-info" href="deletefarmerlist.php?fr_id=<?php echo $fr_id;?>">
