...
<head>
 ...
 <div class="box-content">
    ...
    <tr>
       ...
       <td class="center"> <?php echo $row['packagename'];?></td>
	    <td class="center"> <?php echo $row['duration'];?></td>
		 <td class="center"> <?php echo $row['rate'];?></td>
		  <td class="center"> <?php echo $row['description'];?></td>
         <td class="center">
            
          <form name="frm_package_<?php echo $row['package_id'];?>" action="updatepackage.php" method="post">
			...
			<input type="submit" class="btn btn-info" name="frm_package_submit_<?php echo $row['package_id'];?>" value="Update" />
		  </form>
